...
def main():
    parser = argparse.ArgumentParser(description="Hound - Phase 2 CLI")
    parser.add_argument("command", choices=["scrape", "prompt", "allwork"], help="Command to run")
